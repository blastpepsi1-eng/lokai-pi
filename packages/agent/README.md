...
Stateful agent with tool execution and event streaming. Built on `@blastpepsi1-eng/lokai-ai`.

## Installation

```bash
npm install @blastpepsi1-eng/lokai-agent-core
```
...
```typescript
import { Agent, streamProxy } from "@blastpepsi1-eng/lokai-agent-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@blastpepsi1-eng/lokai-agent-core";
