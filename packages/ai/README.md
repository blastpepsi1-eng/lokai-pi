...
```bash
npm install @blastpepsi1-eng/lokai-ai
```

TypeBox exports are re-exported from `@blastpepsi1-eng/lokai-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@blastpepsi1-eng/lokai-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@blastpepsi1-eng/lokai-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@blastpepsi1-eng/lokai-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@blastpepsi1-eng/lokai-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@blastpepsi1-eng/lokai-ai';
...
```typescript
import { getModel, stream } from '@blastpepsi1-eng/lokai-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@blastpepsi1-eng/lokai-ai';
...
```typescript
import { Model, stream } from '@blastpepsi1-eng/lokai-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@blastpepsi1-eng/lokai-ai';
...
```typescript
import { getModel, complete, Context } from '@blastpepsi1-eng/lokai-ai';
...
```typescript
import { Context, getModel, complete } from '@blastpepsi1-eng/lokai-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@blastpepsi1-eng/lokai-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@blastpepsi1-eng/lokai-ai';
...
```bash
npx @blastpepsi1-eng/lokai-ai login              # interactive provider selection
npx @blastpepsi1-eng/lokai-ai login anthropic    # login to specific provider
npx @blastpepsi1-eng/lokai-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@blastpepsi1-eng/lokai-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@blastpepsi1-eng/lokai-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@blastpepsi1-eng/lokai-ai/oauth';
...
```typescript
import { getModel, complete } from '@blastpepsi1-eng/lokai-ai';
import { getOAuthApiKey } from '@blastpepsi1-eng/lokai-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@blastpepsi1-eng/lokai-ai`
