...
```bash
npm install @blastpepsi1-eng/lokai-coding-agent
```
...
```typescript
import { createAgentSession } from "@blastpepsi1-eng/lokai-coding-agent";
...
The `Agent` class (from `@blastpepsi1-eng/lokai-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { AuthStorage, ModelRegistry } from "@blastpepsi1-eng/lokai-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@blastpepsi1-eng/lokai-coding-agent";
...
import { createAgentSession, defineTool } from "@blastpepsi1-eng/lokai-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@blastpepsi1-eng/lokai-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@blastpepsi1-eng/lokai-coding-agent";
