...
**Source:** [`@blastpepsi1-eng/lokai-tui`](https://github.com/badlogic/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@blastpepsi1-eng/lokai-tui";
...
```typescript
import { Container, type Focusable, Input } from "@blastpepsi1-eng/lokai-tui";
...
Import from `@blastpepsi1-eng/lokai-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@blastpepsi1-eng/lokai-tui";
```
...
```typescript
import { matchesKey, Key } from "@blastpepsi1-eng/lokai-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@blastpepsi1-eng/lokai-tui";
...
```typescript
import { getMarkdownTheme } from "@blastpepsi1-eng/lokai-coding-agent";
import { Markdown } from "@blastpepsi1-eng/lokai-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@blastpepsi1-eng/lokai-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@blastpepsi1-eng/lokai-coding-agent";
import { DynamicBorder } from "@blastpepsi1-eng/lokai-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@blastpepsi1-eng/lokai-tui";
...
```typescript
import { BorderedLoader } from "@blastpepsi1-eng/lokai-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@blastpepsi1-eng/lokai-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@blastpepsi1-eng/lokai-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@blastpepsi1-eng/lokai-tui";
...
import { matchesKey, truncateToWidth } from "@blastpepsi1-eng/lokai-tui";
