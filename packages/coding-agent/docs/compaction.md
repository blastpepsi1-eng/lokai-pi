...
For TypeScript definitions in your project, inspect `node_modules/@blastpepsi1-eng/lokai-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@blastpepsi1-eng/lokai-coding-agent";
