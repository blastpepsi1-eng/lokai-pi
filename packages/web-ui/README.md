# @blastpepsi1-eng/lokai-web-ui

Reusable web UI components for building AI chat interfaces powered by [@blastpepsi1-eng/lokai-ai](../ai) and [@blastpepsi1-eng/lokai-agent-core](../agent).
...
```bash
npm install @blastpepsi1-eng/lokai-web-ui @blastpepsi1-eng/lokai-agent-core @blastpepsi1-eng/lokai-ai
```
...
```typescript
import { Agent } from '@blastpepsi1-eng/lokai-agent-core';
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@blastpepsi1-eng/lokai-web-ui';
import '@blastpepsi1-eng/lokai-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@blastpepsi1-eng/lokai-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@blastpepsi1-eng/lokai-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@blastpepsi1-eng/lokai-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@blastpepsi1-eng/lokai-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@blastpepsi1-eng/lokai-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@blastpepsi1-eng/lokai-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@blastpepsi1-eng/lokai-web-ui';
...
```typescript
import { SessionListDialog } from '@blastpepsi1-eng/lokai-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@blastpepsi1-eng/lokai-web-ui';
...
```typescript
import { ModelSelector } from '@blastpepsi1-eng/lokai-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@blastpepsi1-eng/lokai-web-ui';
